...
"""
    ...
    return {
        ...
        "policy_sha256": manifest["source_sha256"][
            "generals/agents/sentinel_agent.py"
            if variant == "v2"
            else "generals/agents/sentinel_v10_agent.py"
            if variant.startswith("v10")
