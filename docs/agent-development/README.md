...
The [V15 opening experiment](v15-development.md) completes all 24 games and
rejects both modes: each loses its six selected games. All 92 small frontier
captures execute and 90 survive their next land tick, but this does not preserve
winning routes, economic investment or defense. Eighteen tests and warm profiling
pass; the [preflight](v15-preflight-evidence.json) does not qualify cold startup.
...
[capture-chain experiment](v17-development.md) implements continuations from the
same packet. Its [completed 24-game Zephyrus screen](v17-results.md) rejects V17:
two my_bot9 wins and four Amin/Juraj losses despite 214 confirmed chain captures.
Host correctness and warm runtime pass. Complete failure audits identify earlier
allocation and threat-visibility gaps; all 590 original my_bot9 invalid builds
